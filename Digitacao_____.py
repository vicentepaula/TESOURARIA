...
class Digitacao:
    ...
    def acertoOperador(self,dta):
        ...
        #varQueryLojas ="select nroempresa, empresa from CONSINCO.dim_empresa where nroempresa not in (99, 800, 986, 987, 989, 999, 13, 20, 25,29) AND NROEMPRESA > 22 order by NROEMPRESA"
        #varQueryLojas ="select nroempresa, empresa from CONSINCO.dim_empresa where nroempresa not in (99, 800, 986, 987, 989, 999, 13, 20, 25,29) AND NROEMPRESA = 22 order by NROEMPRESA"
           ...
           #Apagando a informação na caixa de data.
            ...
            for row_movimento_banco in reult_movimento: #Loop do banco de dados
              ...
              ##############################################################  
               ...
               varArquivosLojas =f"C:\\Projetos_Python\\TESOURARIA\\arquivos\\digitacao\\movimentolj{strLoja}.csv"
                           ...
                           #   srtDinheiroSistema = srtDinheiroSistema_2.window_text()
                             ...
                             # window = None                                                                                                                                          
                              ...
                              if varControleDigitacao >= "1":
                                 ...
                                 guptadialog_01[u'Button3'].click_input() #Click na no  botão conciliar janela outros
                                 pyautogui.sleep(0.25)
